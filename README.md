...
- **Our Repository**: Download the source code and assets from the [GitHub repository](https://github.com/Potato-Programmer-Developers/Aisling).
...
4. If your computer is not set up for make, you can use the following command:
    ```
    gcc -Iinclude main.c -o main.exe -Llib -lraylib -lsettings -lcharacter -laudio -lscene -linteractive -lmap -lgame_context -ldata -ldialogue -lopengl32 -lgdi32 -lwinmm
    ```
...
After a successful build, run the executable: `.\main.exe`
